...
You can use the OpenShift UI to deploy a mobile app by downloading the binary directly to the mobile device, this binary can be downloaded for any succesfult build in 
the build history.
